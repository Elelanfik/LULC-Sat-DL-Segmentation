...
def convolution_block(block_input, num_filters=256, kernel_size=3, dilation_rate=4, padding='same', use_bias=False):
    x = Conv2D(
        num_filters, 
...
with strategy.scope():
    ...
    latest_checkpoint_path = "/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/DEEPV3XCEPTION.weights.h5"
    try:
    ...
    best_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/DEEPXCEP_best.weights.h5",
    ...
    last_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/DEEPXCEP_latest.weights.h5",
        save_weights_only=True,
        verbose=1
    )
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/DEPXCEP1LOSS.png')
plt.show()
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/DEPXCEP1dice.png')
plt.show()
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/DEPXCEP1JAC.png')
plt.show()
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/RESULT_FIGURE/DEPXCEP1IOU.png')
plt.show()
plt.close()
