...
from tensorflow.keras.layers import (Input, Conv2D, BatchNormalization, ReLU, Dropout, 
...
def DeeplabV3Plus(image_size, num_classes):
    ...
    x = mobilenet.get_layer('block_13_expand_relu').output
    x = DilatedSpatialPyramidPooling(x)
    input_a = UpSampling2D(size=(image_size // x.shape[1], image_size // x.shape[2]), interpolation='bilinear')(x)
    input_b = mobilenet.get_layer('block_4_expand_relu').output
...
with strategy.scope():
    ...
    latest_checkpoint_path = "/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/AEDEEPMOB_best.weights.h5"
    try:
    ...
    best_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/AEDEEPMOB_best.weights.h5",
    ...
    last_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/AEDEEPMOB_latest.weights.h5",
        save_weights_only=True,
        verbose=1
    )
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/AEDEEPMOBLOSS.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/AEDEEPMOBdice.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/AEDEEPMOBAC.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/AEDEEPMOBIOU.png')
plt.close()
