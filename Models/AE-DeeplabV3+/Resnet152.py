...
def squeeze_excite_block(input_tensor, ratio=4, dropout_rate=0.3):
...
def DilatedSpatialPyramidPooling(input_tensor, dropout_rate=0.3):
...
def DeeplabV3Plus(image_size, num_classes, dropout_rate=0.3):
...
with strategy.scope():
    ...
    latest_checkpoint_path = "/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/AEDEEPRES152_latest.weights.h5"
    try:
    ...
    best_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/AEDEEPRES152_best.weights.h5",
    ...
    last_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/AEDEEPRES152_latest.weights.h5",
        save_weights_only=True,
        verbose=1
    )
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/AEDEEPRES152LOSS.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/AEDEEPRES152dice.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/AEDEEPRES152JAC.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/AEDEEPRES152IOU.png')
plt.close()
