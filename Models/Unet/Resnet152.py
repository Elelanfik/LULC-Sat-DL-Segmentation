...
from tensorflow.keras.applications import ResNet101, ResNet152, Xception, MobileNetV2
...
# U-Net Model with ResNet152 Backbone
def resnet152_unet(input_shape, *, classes, dropout):
    inputs = Input(input_shape)
    resnet152 = ResNet152(include_top=False, weights="imagenet", input_tensor=inputs)
    
    s1 = resnet152.get_layer("conv1_relu").output
    s2 = resnet152.get_layer("conv2_block3_out").output
    s3 = resnet152.get_layer("conv3_block8_out").output
    s4 = resnet152.get_layer("conv4_block36_out").output
    x = resnet152.get_layer("conv5_block3_out").output
...
with strategy.scope():
    ...
    model = resnet152_unet(input_shape, classes=n_classes, dropout=0.3)
    ...
    latest_checkpoint_path = "/home/rdadmin/Tsiyon/Modelsaved/UNET/256/RESNET152best.weights.h5"
    try:
    ...
    best_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/UNETRES152_best.weights.h5",
    ...
    last_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/UNETRES152_latest.weights.h5",
        save_weights_only=True,
        verbose=1
    )
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETRES152LOSS.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETRES152dice.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETRES152JAC.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETRES152IOU.png')
plt.close()
