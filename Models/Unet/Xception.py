...
def decoder_block(x, y, filters):
    ...
    y = ZeroPadding2D(((0, x.shape[1] - y.shape[1]), (0, x.shape[2] - y.shape[2])))(y)
...
# Modify the U-Net function to use Xception
def xception_unet(input_shape, classes, dropout):
...
with strategy.scope():
    ...
    model = xception_unet(input_shape, classes=n_classes, dropout=0.3)
    ...
    latest_checkpoint_path = "/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/UNETXCEP_latest_latest.weights.h5"
    try:
    ...
    best_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/UNETXCEP_best.weights.h5",
    ...
    last_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/UNETXCEP_latest.weights.h5",
        save_weights_only=True,
        verbose=1
    )
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETXCEPLOSS.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETXCEPdice.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETXCEPJAC.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/RESULT_FIGURE/UNETXCEPIOU.png')
plt.close()
