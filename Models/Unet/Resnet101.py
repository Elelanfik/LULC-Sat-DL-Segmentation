...
A deep learning model combining ResNet101 encoder with UNet decoder for semantic segmentation 
of land cover types from satellite/aerial imagery.
"""
...
def build_resnet101_unet(input_shape=INPUT_SHAPE, num_classes=NUM_CLASSES, dropout_rate=DROPOUT_RATE):
    """
    Build ResNet101-UNet hybrid model
    ...
    s4 = resnet.get_layer("conv4_block23_out").output
    ...
    return Model(inputs, outputs, name="ResNet101_U-Net")
