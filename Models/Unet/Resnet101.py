...
from tensorflow.keras.applicagtions import ResNet101
...
from tensorflow.keras.layers import Conv2D, Conv2DTranspose, BatchNormalization, LeakyReLU, UpSampling2D, concatenate, Dropout
from tensorflow.keras.models import Model
from tensorflow.keras.optimizers import Adam
...
from tensorflow.keras.utils import Sequence
import albumentations as A
from tensorflow.keras.layers import UpSampling2D, concatenate, Conv2D, BatchNormalization, LeakyReLU, ZeroPadding2D
from tensorflow.keras.regularizers import l2
from tensorflow.keras.initializers import he_normal
from tensorflow.keras import backend as K
import keras.regularizers
from tensorflow.keras.layers import (
    Input, Conv2D, Conv2DTranspose, BatchNormalization, LeakyReLU,
    Dropout, UpSampling2D, concatenate
)
from tensorflow.keras.models import Model
from tensorflow.keras.applications import Xception
from tensorflow.keras import Input, Model
from tensorflow.keras.layers import Conv2D, Conv2DTranspose, UpSampling2D, BatchNormalization, LeakyReLU, Dropout, concatenate, ZeroPadding2D
from tensorflow.keras.applications import Xception
import cv2
import pandas as pd
import math
...
def decoder_block(x, y, filters, dropout_rate=0.3):
    ...
    x = Conv2D(filters, 3, padding='same', kernel_regularizer=tf.keras.regularizers.l2(0.1))(x)
...
def resnet101_unet(input_shape, *, classes, dropout):
    ...
    s1 = resnet101.get_layer("conv1_relu").output
    s2 = resnet101.get_layer("conv2_block3_out").output
    s3 = resnet101.get_layer("conv3_block4_out").output
    s4 = resnet101.get_layer("conv4_block23_out").output
...
with strategy.scope():
    ...
    model = resnet101_unet(input_shape, classes=n_classes, dropout=0.3)
    ...
    latest_checkpoint_path = "/home/rdadmin/Tsiyon/Modelsaved/UNET/256/RESNET101best.weights.h5"
    try:
    ...
    best_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/UNETRES101_best.weights.h5",
    ...
    last_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/UNETRES101_latest.weights.h5",
        save_weights_only=True,
        verbose=1
    )
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETRES101LOSS.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETRES101dice.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETRES101JAC.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/UNETRES101IOU.png')
plt.close()
