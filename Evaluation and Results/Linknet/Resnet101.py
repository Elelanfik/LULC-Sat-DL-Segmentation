...
from tensorflow.keras.applications import Xception, ResNet101, MobileNetV2
...
def resnet101_linknet(input_shape, classes, dropout):
    ...
    s3 = resnet.get_layer("conv3_block4_out").output  # 16x16x512 (adjusted to the correct existing layer)
    s4 = resnet.get_layer("conv4_block23_out").output  # 8x8x1024 (adjusted to the correct existing layer)
    x = resnet.get_layer("conv5_block3_out").output  # 4x4x2048
    ...
    model = Model(inputs, outputs, name="ResNet101_LinkNet")
    return model
...
with strategy.scope():
    ...
    model = resnet101_linknet(input_shape, classes=n_classes, dropout=0.3)
    ...
    latest_checkpoint_path = "/home/rdadmin/Tsiyon/Modelsaved/LINKNE/256/LMRES50best.weights.h5"
    try:
    ...
    best_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/LINKNETRES101_best.weights.h5",
    ...
    last_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/LINKNETRES101_latest.weights.h5",
        save_weights_only=True,
        verbose=1
    )
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/LINKNETRES101LOSS.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/LINKNETRES101dice.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/LINKNETRES101JAC.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/LINKNETRES101IOU.png')
plt.close()
