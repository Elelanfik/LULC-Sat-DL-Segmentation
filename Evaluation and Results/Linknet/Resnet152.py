...
from tensorflow.keras.applications import Xception, MobileNetV2, ResNet101, ResNet152, EfficientNetB5
from tensorflow.keras.layers import (
    Conv2D, Conv2DTranspose, BatchNormalization, LeakyReLU, UpSampling2D,
    concatenate, Dropout, ZeroPadding2D, Add
)
...
def decoder_block(x, y, filters, dropout_rate=0.3):
    ...
    x = Dropout(dropout_rate)(x)
    return x
def resnet152_linknet(input_shape, classes, dropout):
    ...
    s3 = resnet.get_layer("conv3_block8_out").output  # 16x16x512
    s4 = resnet.get_layer("conv4_block36_out").output  # 8x8x1024
    ...
    model = Model(inputs, outputs, name="ResNet152_LinkNet")
...
with strategy.scope():
    ...
    model = resnet152_linknet(input_shape, classes=n_classes, dropout=0.3)
    ...
    latest_checkpoint_path = "/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/LINKNETRES152_latest.weights.h5"
    try:
    ...
    best_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/LINKNETRES152_best.weights.h5",
    ...
    last_checkpoint = ModelCheckpoint(
        filepath="/home/rdadmin/Tsiyon/NEWONE/MODELSAVED/LINKNETRES152_latest.weights.h5",
        save_weights_only=True,
        verbose=1
    )
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/LINKNETRES152LOSS.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/LINKNETRES152dice.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/LINKNETRES152JAC.png')
plt.close()
...
plt.xticks(x_ticks)
plt.legend()
plt.savefig('/home/rdadmin/Tsiyon/NEWONE/RESULT/LINKNETRES152IOU.png')
plt.close()
